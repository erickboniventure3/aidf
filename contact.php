...
<html class="no-js" lang="zxx">
   ...
   <style>
         ...
         .contact-hero {
            background: linear-gradient(135deg, rgba(0, 166, 81, 0.9), rgba(0, 123, 62, 0.9));
         ...
         .btn-contact {
            background: linear-gradient(135deg, #00a651, #007b3e);
            border: none;
            padding: 15px 40px;
            border-radius: 8px;
            color: white;
   ...
   <body>
         ...
         <div class="color-switch-btns"><button data-color="#6240CF"><i class="fa-solid fa-droplet"></i></button> 
            <button data-color="#068FFF"><i class="fa-solid fa-droplet"></i></button> <button data-color="#044DBC">
               <i class="fa-solid fa-droplet"></i></button> <button data-color="#FFAF00"><i class="fa-solid fa-droplet"></i></button>
                <button data-color="#F80000"><i class="fa-solid fa-droplet"></i></button> <button data-color="#231E7A"><i class="fa-solid fa-droplet"></i></button></div>
      ...
      <section class="contact-info">
         <div class="container">
           <h1>Contact Us</h1>
         <p>Have questions or want to get involved? Reach out to us! We are here to connect, collaborate, and create positive change together. Whether you want to kearn more about our work, discuss partinership opportunities, or share your ideas, we would love tohear from you. Contact us today and Let's make a difference together!</p>
            ...
            <div class="row g-4">
               ...
               <div class="col-lg-3 col-md-6">
                  <div class="contact-card">
                     ...
                     <h4>Address</h4>
                     <p>Dar es Salaam, Tanzania<br>East Africa</p>
                  </div>
               </div>
               <div class="col-lg-3 col-md-6">
                  <div class="contact-card">
            ...
            <div class="row g-5">
               ...
               <div class="col-lg-6">
                  <div class="map-container">
                     <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3961.771!2d39.2083!3d-6.7924!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNsKwNDcnMzYuOCJTIDM5wrAxMiMzMC4wIkU!5e0!3m2!1sen!2stz!4v1638360000000!5m2!1sen!2stz" allowfullscreen="" loading="lazy"></iframe>
                  </div>
               </div>
            </div>
         </div>
      ...
      <section class="social-links">
         <div class="container">
            <h3 class="text-center mb-4">Follow Us on Social Media</h3>
      ...
      <script>
         ...
         document.addEventListener('DOMContentLoaded', function() {
            ...
            if (status === 'success') {
               ...
               showAlert('Your message was saved, but we encountered an issue sending the confirmation email. Please try again later.', 'warning');
            } else if (status === 'db_error') {
               showAlert('Sorry, there was an error saving your message. Please try again or contact us directly.', 'error');
            } else if (status === 'validation_error' && errors) {
               showAlert('Please correct the following errors: ' + errors, 'error');
            }
         });
